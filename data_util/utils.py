...
def write_for_rouge(article_str, reference_sents, decoded_words, ex_index,
                    _rouge_article_dir, _rouge_ref_dir, _rouge_dec_dir):
  decoded_sents = []
  # print(decoded_words)
  decoded_words = [word.decode('utf-8') if type(word)==bytes else word for word in decoded_words]
  ...
  article_file = os.path.join(_rouge_article_dir, "%06d_article.txt" % ex_index)
