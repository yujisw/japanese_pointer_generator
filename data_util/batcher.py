  ...
  def text_generator(self, example_generator):
    while True:
      ...
      try:
        ...
        article_text = ' '.join(article_text[:300])
        ...
        # print("article length: {}, abstract length: {}".format(len(article_text),len(abstract_text)))
      except ValueError:
        tf.logging.error('Failed to get article or abstract from example')
        continue
      if len(article_text)<200: # See https://github.com/abisee/pointer-generator/issues/1
